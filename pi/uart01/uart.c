...
// BCM2835 SOC peripherals - Page 89
...
// BCM2835 SOC peripherals - Page 8-19
...
// interrupt register address to use on uart
// BCM2835 SOC peripherals - Page 109-113
#define INT_GPU_ENABLE0  0x2000B210
...
{
  write32(AUX_MU_IER_REG, read32(AUX_MU_IER_REG) |= 0x1);
  write32(INT_GPU_ENABLE0, read32(INT_GPU_ENABLE0) |= (1 << 29));
}
...
void hexstring ( unsigned int d, const char *s )
{
  unsigned int rb;
  unsigned int rc;
